...
run_list "recipe[java]", "recipe[tomcat]", "role[web-server]", "recipe[map-display-3::application-01]", "recipe[map-display-3::contentloader]", "recipe[map-display-3::vhost]", "recipe[map-display-3::lpa_vhost]", "role[stage-jenkins-agent]"
