...
run_list "role[java_builder]", "role[tomcat]", "recipe[mms-2::application]", "recipe[mms-2::cs-tools]", "recipe[mms-2::cs-batch]", "recipe[mms-2::hudson-vars]", "recipe[smoke_test]"
