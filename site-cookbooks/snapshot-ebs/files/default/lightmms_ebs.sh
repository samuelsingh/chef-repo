...
LOG_FILE=/var/log/lightmms_backup.log

if [ -z "$1" ]; then 
echo "usage: ./lightmms_ebs.sh <VOLUME ID> <No of Snapshots to retain>"
...
ec2-create-snapshot $1 1>> $LOG_FILE
php /usr/local/bin/remove_old_snapshots.php -v $1 -n $2
# Log to file
